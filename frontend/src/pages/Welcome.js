...
function Welcome(){
   return( <div>
        <div className="space-x-4 w-full max-w-3xl h-screen bg-cover flex justify-left  items-center sm:text-center  " style={{backgroundImage:"url('/images/im.jpg')"}} > 
         <div>
        ...
        <div className='border-t w-full max-w-3xl  items-center px-4 sm:px-6 md:px-8 flex flex-col border-gray-300  bg-blue-600 h-screen'>
