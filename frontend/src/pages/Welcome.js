...
function Welcome(){
   return( <div className='inset-0 left-0 right-0 overflow-x-hidden   ' >
        ...
        <div className='border-t w-full items-center  md:w-lg  px-4 sm:item-left md:px-8 flex flex-col border-gray-300  bg-blue-600 min-h-screen'>
            <div className='text-center flex flex-col  sm:text-left w-full max-w-4xl '>
              <p className='	max-w-prose  text-left sm:justify   mb-8  text-white mt-12 sm:mt-20  sm:mb-12 mx-auto px-4  md:max-w-lg lg:max-w-3xl  leading-relaxed  text-base sm:text-lg md:text-xl  '>  At Digital Housing, we revolutionize the way you find and manage homes.
